-- Restaura sp_paciente_guardar a su firma original (28 params, sin correoP)
-- por si ya se habia ejecutado una version anterior del script de migracion
-- que sobreescribio este procedimiento con 29 params bajo el mismo nombre.
-- La version anterior del backend en produccion depende de esta firma exacta.
